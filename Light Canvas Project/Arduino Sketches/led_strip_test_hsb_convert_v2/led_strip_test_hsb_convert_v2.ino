...
void setup(){
  ...
  //test other strips to see if they work
//  for(int i = 0; i < strip1.numPixels(); i++){
//    strip2.setPixelColor(i, strip1.Color(0, 255, 0));
//    strip2.show();
//  }
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    if (ch == '\n') {
      ...
      hsi2rgb(data[1], data[2], data[3], rgb1);
      hsi2rgb(data[5], data[6], data[7], rgb2);
      hsi2rgb(data[9], data[10], data[11], rgb3);
      hsi2rgb(data[13], data[14], data[15], rgb4);
      hsi2rgb(data[17], data[18], data[19], rgb5);
      hsi2rgb(data[21], data[22], data[23], rgb6);

      
      
      //and put the 3 values in our local variables

        strip1.setPixelColor(data[0], strip1.Color(rgb1[0], rgb1[1], rgb1[2]));
        strip1.show();

        strip2.setPixelColor(data[4] - 96, strip2.Color(rgb2[0], rgb2[1], rgb2[2]));
        strip2.show();       

        strip3.setPixelColor(data[8] - 192, strip3.Color(rgb3[0], rgb3[1], rgb3[2]));
        strip3.show();       

        strip4.setPixelColor(data[12] - 288, strip4.Color(rgb4[0], rgb4[1], rgb4[2]));
        strip4.show();       

        strip5.setPixelColor(data[16] - 384, strip5.Color(rgb5[0], rgb5[1], rgb5[2]));
        strip5.show();       

        strip6.setPixelColor(data[20] - 480, strip6.Color(rgb6[0], rgb6[1], rgb6[2]));
        strip6.show();       
