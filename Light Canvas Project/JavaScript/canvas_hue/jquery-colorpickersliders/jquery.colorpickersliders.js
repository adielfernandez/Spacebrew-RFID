        ...
        return this.each(function() {
            ...
            function _buildHtml() {
                ...
                if (settings.order.preview !== false) {
                    sliders[settings.order.preview] = '<div id="preview" class="cp-preview cp-transparency"><div class="dummyclass"></div><input class="textinput" type="text" readonly="readonly"></div>';
                }
